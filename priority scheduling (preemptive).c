...
int main()
{
    ...
    printf("==== this is a priority algorithm ====");
    ...
    while(completed < n)
    {
        ...
        {
            rt[highest_pri_index]--;
            time++;
            if(rt[highest_pri_index]==0)
            {
                completed++;
